...
| Descriptive: "understand / map how this repo works" | Codebase Analysis Report | `templates/codebase-analysis-report.md` via `references/route-codebase-analysis.md` |
