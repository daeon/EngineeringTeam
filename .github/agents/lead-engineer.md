...
Coordinates multi-agent software engineering work, selects suitable agents, builds repo-intelligence artifacts, resolves evidence conflicts, gates implementation, and produces final plans and reports.
